...
export default function ContactPage() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-4 mb-10">
                {/* Director */}
                <div className="flex items-center gap-4 p-5 bg-saccs-light rounded-2xl hover:shadow-saccs-md transition-all duration-300">
                ...
                <a 
                  ...
                  className="flex items-center gap-4 p-5 bg-saccs-light rounded-2xl hover:shadow-saccs-md transition-all duration-300 group"
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-primary to-primary-light rounded-xl flex items-center justify-center text-white flex-shrink-0">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <a 
                  ...
                  className="flex items-center gap-4 p-5 bg-[#25D366]/10 rounded-2xl hover:shadow-saccs-md transition-all duration-300 group border-2 border-[#25D366]/20 hover:border-[#25D366]/50"
                >
              ...
              {/* Business Hours */}
              <div className="mt-8 p-6 bg-saccs-light rounded-2xl">
            ...
            <div>
              <div className="bg-white p-8 rounded-2xl shadow-saccs-lg border border-gray-100">
                ...
                <form className="space-y-6">
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-saccs-text mb-2">
                      Onderwerp *
                    </label>
                    <input
                      type="text"
                  ...
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white font-semibold rounded-xl hover:bg-primary-dark transition-all duration-300 hover:-translate-y-1 hover:shadow-saccs-lg"
                  >
      ...
      {/* Map placeholder */}
      <section className="h-[400px] bg-saccs-light relative">
