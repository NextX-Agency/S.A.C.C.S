...
export const metadata: Metadata = {
  ...
  description:
    "Lees ons privacybeleid om te begrijpen hoe SACCS uw persoonlijke gegevens verzamelt, gebruikt en beschermt.",
};
        ...
        <div className="container">
          <div className="legal-copy">
            ...
            <p className="text-saccs-grey mb-6">
              {siteConfig.fullName} (&ldquo;SACCS&rdquo;, &ldquo;wij&rdquo;,
              &ldquo;ons&rdquo;) respecteert uw privacy en zet zich in voor de
              bescherming van uw persoonlijke gegevens. Dit privacybeleid legt
              uit hoe wij uw persoonlijke informatie verzamelen, gebruiken en
              beschermen wanneer u onze website bezoekt of gebruik maakt van
              onze diensten.
            </p>
            ...
            <p className="text-saccs-grey mb-4">
              Wij kunnen de volgende categorieën persoonlijke gegevens
              verzamelen:
            </p>
            <ul className="list-disc pl-6 text-saccs-grey space-y-2 mb-6">
              ...
              <li>
                <strong>Bedrijfsgegevens:</strong> bedrijfsnaam, functie (indien
                van toepassing)
              </li>
              <li>
                <strong>Communicatiegegevens:</strong> inhoud van berichten die
                u ons stuurt
              </li>
              <li>
              ...
              <li>
                <strong>Gebruiksgegevens:</strong> hoe u onze website gebruikt
                en navigeert
              </li>
            </ul>
            ...
            <p className="text-saccs-grey mb-6">
              ...
              Wij kunnen uw gegevens alleen delen met:
            </p>
            <ul className="list-disc pl-6 text-saccs-grey space-y-2 mb-6">
            ...
            <p className="text-saccs-grey mb-6">
              Onze website kan cookies gebruiken om uw ervaring te verbeteren.
              Cookies zijn kleine tekstbestanden die op uw apparaat worden
              opgeslagen. U kunt uw browserinstellingen aanpassen om cookies te
              weigeren.
            </p>
