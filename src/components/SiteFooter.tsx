    ...
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading text-lg font-bold mb-6">Snelle Links</h3>
          ...
          {/* Legal */}
          <div>
            <h3 className="font-heading text-lg font-bold mb-6">Juridisch</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                ...
                >
                  <svg className="w-5 h-5 mt-0.5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                  <span className="group-hover:text-white">{contactInfo.phone.display}</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="group-hover:text-white break-all">{contactInfo.email.display}</span>
                </a>
              </li>
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#20bd5a] transition-colors mt-2"
                >
